...
class _MyAppState extends State<MyApp> {
  ...
  late StreamSubscription<LanguageState> listenerStream;
  ...
  void startListeningChangeLanguage() {
    final languageChange = BlocProvider.of<LanguageCubit>(context);
    listenerStream = languageChange.stream.listen((state) {
      if (state is LanguageChanged) {
        _changeLanguage(state.languageCode);
